...
PARAMETER_SECTION
  ...
  init_bounded_vector sigma_m(1,2,0.01,6,est_sigma_m)
  init_bounded_vector log_m_mu(1,2,-5,3,est_log_m_mu)
  init_bounded_vector prop_rec(styr,endyr,0.01,1,2)
  init_bounded_vector sigma_q(1,2,0.01,6,est_sigma_q)
  ...
  sdreport_vector imm_n_sd(styr,endyr)
  sdreport_vector mat_n_sd(styr,endyr) 
...
FUNCTION evaluate_the_objective_function
  ...
  for (int year=styr;year<=endyr;year++)
   ...
   imm_n_sd = imm_numbers_pred;
   mat_n_sd = mat_numbers_pred;
