 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  sigma_m.allocate(1,2,0.01,6,est_sigma_m,"sigma_m");
  log_m_mu.allocate(1,2,-5,3,est_log_m_mu,"log_m_mu");
  prop_rec.allocate(styr,endyr,0.01,1,2,"prop_rec");
  sigma_q.allocate(1,2,0.01,6,est_sigma_q,"sigma_q");
  ...
  #endif
  imm_n_sd.allocate(styr,endyr,"imm_n_sd");
  mat_n_sd.allocate(styr,endyr,"mat_n_sd");
  f.allocate("f");
